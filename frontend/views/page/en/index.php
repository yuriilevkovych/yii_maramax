...
<section><div class="logo"><div class="top_title"></div><div class="bottom_title"></div></div>
    ...
    <div class="color_bg">
        <div class="wrap">
            <div class="title">what products we produce</div>
            <div class="tabs">
                <div id="bx-pager">
                    <a data-slide-index="0" href="" class="active"><span class="check"></span><span class="text">P.o.s. materials</span></a>
                    <a data-slide-index="1" href="" class=""><span class="check"></span><span class="text">Packaging made of cardboard and corrugated board</span></a>
                    <a data-slide-index="2" href="" class=""><span class="check"></span><span class="text">laminated packaging</span></a>
                    <a data-slide-index="3" href="" class=""><span class="check"></span><span class="text">metal p.o.s. materials</span></a>
                </div>
    ...
    <div class="cont_wrap">
            ...
            <div class="wrap">
                ...
                <ul>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Prepress and Print</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">VARNISHING</div>
                            </div>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Stamping and embossing</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Die-cutting</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Engraving FREYZERNYE WORK</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">TERMOGIBKA PLASTIC</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">laminating</div>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="a_dv">
            <div class="wrap">
                <span>advantages of working with us</span>
                <ul>

                    <li>
                        <div class="img" style="background-image: url('/img/2015/06/11.png');"></div>
                        <p>THE BASIS OF OUR WORK IS QUALITY PRODUCTS THAT ARE MADE ON EQUIPMENT FROM EUROPEAN AND ASIAN MANUFACTURERS</p>
                    </li>

                    <li>
                        <div class="img" style="background-image: url('/img/2015/06/21.png');"></div>
                        <p>ALL PRODUCTS ARE MANUFACTURED ON OUR OWN PRODUCTION, WHICH VLIYAETNA THE PRIVACY POLICY</p>
                    </li>

                    <li>
                        <div class="img" style="background-image: url('/img/2015/06/31.png');"></div>
                        <p>WE OPTIMIZE PRICING, ACCORDING TO THE REQUEST OUR CUSTOMERS</p>
                    </li>

                    <li>
                        <div class="img" style="background-image: url('/img/2015/06/41.png');"></div>
                        <p>PRODUCTS MADE IN THE SHORTEST TIME</p>
                    </li>

                    <li>
                        <div class="img" style="background-image: url('/img/2015/06/51.png');"></div>
                        <p>WE USE CREATIVE DESIGN SOLUTIONS TO MEET YOUR NEEDS</p>
                    </li>

                    <li>
                        <div class="img" style="background-image: url('/img/2015/06/61.png');"></div>
                        <p>USE QUALITY MATERIALS FOR PRODUCTION</p>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="wrap">
            ...
            <div class="form">
                ...
                <div role="form" class="wpcf7" id="wpcf7-f1073-o2" lang="ru-RU" dir="ltr">
                    ...
                    <form name="" action="/en/#wpcf7-f1073-o2" method="post" class="wpcf7-form" novalidate="novalidate">
