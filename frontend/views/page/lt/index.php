<section><div class="logo"><div class="top_title"></div><div class="bottom_title"></div></div>
    ...
    <div class="color_bg">
        <div class="wrap">
            <div class="title">kokie produktai gaminame</div>
            <div class="tabs">
                <div id="bx-pager">
                    <a data-slide-index="0" href="" class="active"><span class="check"></span><span class="text">P.o.s. medžiagos</span></a>
                    <a data-slide-index="1" href="" class=""><span class="check"></span><span class="text">Pakuotė pagaminta iš kartono ir gofruotojo kartono</span></a>
                    <a data-slide-index="2" href="" class=""><span class="check"></span><span class="text">Laminuotos pakavimas</span></a>
                    <a data-slide-index="3" href="" class=""><span class="check"></span><span class="text">metalo p.o.s. medžiagos</span></a>
                </div>
            ...
            <div class="wrap">
                ...
                <ul>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Paruošimo ir Spausdinti</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Lakavimas</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">OVERLAMINATE</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Štampavimo ir įspaudimo</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Die pjaustymo</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Graviravimas FREYZERNYE DARBAS</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">TERMOGIBKA PLASTIKINIS</div>
                            </div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="text">
                            <div class="table_v">
                                <div class="table_cell_v">Laminavimo</div>
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <div class="wrap">
            ...
            <div class="form">
                ...
                <div role="form" class="wpcf7" id="wpcf7-f1073-o2" lang="ru-RU" dir="ltr">
                    ...
                    <form name="" action="/lt/#wpcf7-f1073-o2" method="post" class="wpcf7-form" novalidate="novalidate">
